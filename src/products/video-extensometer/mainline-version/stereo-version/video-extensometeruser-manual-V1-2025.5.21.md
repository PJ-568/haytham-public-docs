...
3.将双目设备安装在云台或支架上，调整好水平及高度。

4.按照双目设备预设的距离参数，调整合适的摆放距离，

例：预设距离参数 210mm。

使用卷尺或长度尺等测量“设备前端边缘到试样”的间距，调整到约为 210mm。完成设备和待测试样中心的基本对齐。

5.将光源固定在设备主机或者试验夹具周围。

6.光源连接：将电源线连接至光源控制器上，再通过黑色数据线将光源控制器（CH 接口）与光源连接。

7.设备连接：用数据线将应变仪和电脑主机连接。

8.取下设备镜头防尘盖，按下光源控制器开关，蓝色光源点亮，调整亮度使视野亮度适中。

9.按照试验要求，在待检测试样上检测区域喷涂散斑，并将喷好散斑试样固定在加载装置上。

10.打开电脑，进行软件操作，对设备、灯光等进行微调。
...
# 1. 、软件打开
> 将加密狗 U 盘插入到电脑主机 USB 插口中，双击软件图标<img src="../../../../assets/products/video-extensometer/image16.png"
...
> style="width:3.81667in;height:3.26667in" />
...
> style="width:4.125in;height:1.46667in" />
...
style="width:3.925in;height:1.425in" />
...
> <img src="../../../../assets/products/video-extensometer/image24.jpeg"
