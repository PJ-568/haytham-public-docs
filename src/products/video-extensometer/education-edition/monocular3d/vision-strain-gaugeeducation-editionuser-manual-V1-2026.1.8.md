...
[5.1 模块概述 [12](#模块概述-1)](\l)

[5.2 硬件安装 [13](#硬件安装-1)](\l)

[5.3 软件使用 [13](#软件使用-1)](\l)

[6. 虚拟应变片测量分析模块 [20](#_Toc28195)](\l)

[6.1 模块概述 [20](#模块概述-2)](\l)

[6.2 硬件安装 [20](#硬件安装-2)](\l)

[6.3 软件使用 [22](#软件使用-2)](\l)
...
1.  <span id="_Toc10590" class="anchor"></span>注意事项
...
2.  <span id="_Toc26805" class="anchor"></span>系统介绍
...
-   标记点、喷漆
    ...
    style="width:5.75625in;height:4.31736in" />
...
style="width:5.76528in;height:2.78889in" />

图 1 测量原理示意图

3.  <span id="_Toc9030" class="anchor"></span>软件安装
...
安装完成后桌面上将生成 2 个快捷方式图标<img src="../../../../assets/products/video-extensometer/image7.png"
style="width:0.62811in;height:0.38795in" />，一般只会用到 Galaxy
Viewer 软件<img src="../../../../assets/products/video-extensometer/image8.png"
...
style="width:1.93526in;height:0.71678in" /><img src="../../../../assets/products/video-extensometer/image11.png"
style="width:2.875in;height:0.75in" />

安装完成后，桌面上会分别生成快捷方式图标<img src="../../../../assets/products/video-extensometer/image12.png"
style="width:0.35833in;height:0.39375in" />和<img src="../../../../assets/products/video-extensometer/image13.png"
style="width:0.39375in;height:0.39375in" />。

4.  <span id="_Toc5467" class="anchor"></span>视频引伸计分析模块
...
style="width:5.75972in;height:3.84028in"
alt="640738d316208538913cf77995ed6ae7" />
...
4)  双击 VisualExtensometer 软件桌面快捷方式图标<img src="../../../../assets/products/video-extensometer/image16.png"
...
> style="width:5.75208in;height:3.61597in" />
...
7)  通讯设置，点击菜单栏“配置”按钮，弹出参数设置界面，选定通讯参数配置项选定通讯格式为“UDP_Json”即可实时把变形量传给试验机，生成应力应变曲线
    ...
    style="width:5.75417in;height:3.46181in" />

8)  点击计算，即可计算原始标距、延伸、延伸率数据，并实时显示变形曲线

    <img src="../../../../assets/products/video-extensometer/image23.png"
    style="width:5.75417in;height:3.65347in" />

9)  测试完成，点击左上角“取消”按钮即可结束本次测试

    <img src="../../../../assets/products/video-extensometer/image24.png"
    style="width:5.75833in;height:2.83264in" />

10) 结果输出，可以变形量传给试验机软件可以计算出模量，泊松比，N 值 R 值，断裂伸长率等结果参数，也可把试验机力值导入视频引伸计软件生成对应的结果参数

    <img src="../../../../assets/products/video-extensometer/image25.png"
    style="width:5.63125in;height:3.52986in" />

<!-- -->

5.  <span id="_Toc23187" class="anchor"></span>三维全场应变测量分析模块
...
<img src="../../../../assets/products/video-extensometer/image26.jpeg"
style="width:4.675in;height:2.62986in"
alt="7de25ba5a4f756dfe77a48fc68fabdaa" />
...
style="width:5.75556in;height:3.35625in" />
...
style="width:5.76319in;height:3.57639in" />

7)  图片视频导出，点击软件右上角导出设置可以设置导出图片或者视频模板

<img src="../../../../assets/products/video-extensometer/image40.png"
style="width:5.75833in;height:2.68611in" />

点击生成动画和图片可以分别导出视频和动画

<img src="../../../../assets/products/video-extensometer/image41.png"
style="width:5.75972in;height:2.71528in" />

6.  <span id="_Toc28195" class="anchor"></span>虚拟应变片测量分析模块
...
1)  散斑制备，如下图可以在被测部位贴水转印或者盖上散斑印章
    ...
    <img src="../../../../assets/products/video-extensometer/image42.jpeg"
    style="width:5.64306in;height:3.34444in" alt="FRCT9667" />
